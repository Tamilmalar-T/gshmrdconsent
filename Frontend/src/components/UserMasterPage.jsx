  ...
  return (
    <div className="patient-register-container">
      ...
      <div className="pr-card-box">
        ...
        {/* Card Header Strip */}
        <div className="pr-card-header-strip" style={{ backgroundColor: editingUserId ? '#6366f1' : '#0284c7' }}>
          <UserPlus size={16} />
        ...
        <div className="pr-card-body">
          ...
          <form onSubmit={handleSubmit}>
            <div className="pr-form-4col-grid">
              ...
              {/* USER TYPE - dynamic from Type Master */}
              <div className="pr-field">
                ...
                >
                  {userTypes.length > 0 ? (
                    userTypes.map(t => (
                      <option key={t.typeCode} value={t.typeName}>{t.typeName}</option>
                    ))
                  ) : (
                  ...
                  {form.signatureImage && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <img 
                        ...
                        style={{ height: '34px', border: '1px dashed #cbd5e1', borderRadius: '4px', padding: '2px', backgroundColor: '#f8fafc' }} 
                      />
                      <button
                        type="button"
                        onClick={() => setForm(prev => ({ ...prev, signatureImage: '' }))}
                        style={{ padding: '4px 8px', fontSize: '10px', color: '#ef4444', border: '1px solid #fee2e2', borderRadius: '4px', backgroundColor: '#fee2e2', cursor: 'pointer', fontWeight: 'bold' }}
                      >
                        Clear
                      </button>
                    </div>
            ...
            <div className="pr-form-footer-actions">
              ...
              <button 
                ...
                style={{ backgroundColor: editingUserId ? '#6366f1' : '#0284c7' }}
              >
